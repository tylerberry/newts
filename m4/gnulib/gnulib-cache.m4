...
gl_LOCAL_DIR([])
gl_MODULES([dirname exit exitfail free getdate getgroups getline gettext gettext-h malloc readutmp realloc strcase strpbrk strstr strtok_r vasprintf xgethostname yesno])
